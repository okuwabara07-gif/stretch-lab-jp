...
export const metadata: Metadata = {
  title: 'ストレッチLab',
  description: 'ストレッチ・柔軟性情報',
  openGraph: { title: 'ストレッチLab', description: 'ストレッチ・柔軟性情報', type: 'website', locale: 'ja_JP', siteName: 'ストレッチLab' },
  twitter: { card: 'summary_large_image', title: 'ストレッチLab', description: 'ストレッチ・柔軟性情報' },
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "ストレッチLab", "description": "ストレッチ・柔軟性情報", "url": "https://stretch-lab-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社"}}`}} />
      </head>
      <body>{children}
